...
<div class="wrap scalyn-mail-relay">
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<p><label for="report-format"><?php esc_html_e( 'Download format', 'scalyn-mail-relay' ); ?></label><br><select id="report-format" name="format"><option value="csv">CSV</option><option value="json">JSON</option></select></p>
